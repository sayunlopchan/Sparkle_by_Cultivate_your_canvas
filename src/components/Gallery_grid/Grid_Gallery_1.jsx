    ...
    <div className='grid-gallary-1-container '>
      ...
      <div className='grid-gallery-1-container-box '>
        ...
        <div className='w-full space-y-5'>
          ...
          <AnimatedComponent2>
            <h1 className='text-red-500 font-[500] text-4xl '>Empowering Young Minds, Shaping Nepal's Future Leaders Through Creativity and Confidence.
            </h1>
          </AnimatedComponent2>
          ...
          <ul className='card-ul'>
            <AnimatedComponent2>
              <li><img src={splashRed} alt="red-splash" className='size-[50px]' />Art</li>
            </AnimatedComponent2>

            <AnimatedComponent2>
              <li><img src={splashGreen} alt="red-splash" className='size-[50px]' />Yoga</li>
            </AnimatedComponent2>

            <AnimatedComponent2>
              <li><img src={splashYelow} alt="red-splash" className='size-[50px]' />Public speaking</li>
            </AnimatedComponent2>

            <AnimatedComponent2>
              <li><img src={splashOrange} alt="red-splash" className='size-[50px]' />Dance</li>
            </AnimatedComponent2>

            <AnimatedComponent2>
              <li><img src={splashPink} alt="red-splash" className='size-[50px]' />Personality development</li>
            </AnimatedComponent2>
